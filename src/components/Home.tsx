    ...
    <div className="home-page-container">
      ...
      <ul className="home-page-list">
        ...
        ✅<b>Filter artworks</b> - Quickly refine your search by source or choose to
          only see artworks that are in public domain
        </li>
        <li>
        ✅<b>Detailed Artwork View</b> - See high-quality images and essential details
          about each piece.
        </li>
        <li>
        ✅<b>Curate Your Own Exhibition</b> - Save artworks to a personal, temporary
          exhibition and manage your collection effortlessly.
        </li>
      </ul>
      <h3>Start exploring today and build your own art exhibition! 🖼️✨</h3>
    </div>
    </div>
  );
};
